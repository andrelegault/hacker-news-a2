...
if __name__ == '__main__':
    ...
    infrequent_1.train()
    infrequent_1.remove_where(1) #  removing words with freq == 1
    infrequent_1.test()
    ...
    infrequent_5.train()
    infrequent_5.remove_where(5) #  removing words with freq == 1
    infrequent_5.test()
    ...
    infrequent_10.train()
    infrequent_10.remove_where(10) #  removing words with freq == 1
    infrequent_10.test()
    ...
    infrequent_15.train()
    infrequent_15.remove_where(15) #  removing words with freq == 1
    infrequent_15.test()
    ...
    infrequent_20.train()
    infrequent_20.remove_where(20) #  removing words with freq == 1
    infrequent_20.test()
    ...
    top_5.train()
    top_5.remove_top(0.05) #  removing words with freq == 1
    top_5.test()
    ...
    top_10.train()
    top_10.remove_top(0.10) #  removing words with freq == 1
    top_10.test()
    ...
    top_15.train()
    top_15.remove_top(0.15) #  removing words with freq == 1
    top_15.test()
    ...
    top_20.train()
    top_20.remove_top(0.20) #  removing words with freq == 1
    top_20.test()
    ...
    top_25.train()
    top_25.remove_top(0.25) #  removing words with freq == 1
    top_25.test()
    ...
    ax2.set(xlabel='top %')
    ax1.set_title('Top % used for removal')
    ax2.set_title('Raw frequency count used for removal')
    plt.show()
